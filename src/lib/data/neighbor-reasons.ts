...
export const NEIGHBOR_LABELS: Record<string, string> = {
  ...
  "crisantemo-edule": "Shungiku",
  dragoncello: "Dragoncello (estragon)",
  emerocallide: "Giglio diurno",
  "erba-cipollina": "Erba cipollina",
  fagiolo: "Fagiolo",
  fava: "Fava",
  finocchietto: "Finocchietto",
  finocchio: "Finocchio",
  "fiori-eduli-misti": "Fiori eduli misti",
  "garofano-pink": "Garofano dei poeti",
  "geranio-odoroso": "Geranio odoroso",
  girasole: "Girasole",
  fragola: "Fragola",
  ...
  rosa: "Rosa",
  "rosa-edule": "Rosa (petali)",
  "sambuco-fiore": "Sambuco (fiori)",
  rosmarino: "Rosmarino",
  rucola: "Rucola",
  ruta: "Ruta",
  salvia: "Salvia",
  ...
  songino: "Songino",
  spinacio: "Spinacio",
  "tagete-nano": "Tagete nano",
  timo: "Timo",
  "trifoglio-rosso": "Trifoglio rosso",
  tulbaghia: "Aglio sociale",
  "uva-spina": "Uva spina",
  "viola-odorosa": "Viola mammola",
  "viola-tricolore": "Viola / pensiero",
  zucchina: "Zucchina",
...
const TARGET_COMPANION: Partial<Record<string, string>> = {
  ...
  agastache: "Aromatica che attira impollinatori utili e non compete in profondità con solanacee.",
  borragine: "Richiama api e bombi; in orto tradizionale si affianca a pomodoro e cucurbitacee per impollinazione.",
  calendula: "Fiore copertura che in letteratura orticola confonde afidi e protegge pomodoro e leguminose.",
  "fiori-eduli-misti":
    "Bordura o aiuola mista che attira impollinatori e offre trappole (nasturzio) e copertura senza monocoltura.",
  ...
  cipollotto:
    "Cipolla a mazzetti: odori repellenti utili vicino a carota e lattuga; ciclo rapido a taglio senza bulbo.",
  ...
  nasturzio: "Trappola per afidi sulle brassicacee e solanacee; ciclo rapido e radici superficiali.",
  ...
  "tagete-nano": "Radicine che in consociazione tradizionale riducono nematodi e afidi vicino a solanacee.",
...
const PAIR_COMPANION: Record<string, string> = {
  ...
  "carota:cipollotto":
    "Come cipolla: odori dell’allium riducono la pressione della mosca della carota in consociazione stretta.",
};
...
const TARGET_ANTAGONIST: Partial<Record<string, string>> = {
  ...
  cipollotto:
    "Allium a mazzetti che, come cipolla e porro, interferisce con nodosazione e luce delle leguminose in adiacenza stretta.",
...
const PAIR_ANTAGONIST: Record<string, string> = {
  ...
  "fava:cipollotto": "Come aglio: interferenza con noduli e diverso fabbisogno idrico.",
  ...
  "cipollotto:fava": "Allium che limita luce e nodosazione della fava.",
