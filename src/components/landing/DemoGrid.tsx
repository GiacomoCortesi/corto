...
export function DemoGrid({ step, stepT }: { step: number; stepT?: number }) {
  ...
  // Step 5 (index 4) adds a wide suggestions card on mobile; keep the grid centered by
  // rendering that card outside the `w-fit` grid wrapper.
  if (step === 4) {
    return (
      <div className="w-full">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    cell.season === "harvest" &&
                      "bg-[var(--terracotta)]/12 border-[var(--terracotta)]/30",
                    cell.season === "sowing+transplanting" &&
                      "bg-gradient-to-br from-[var(--sage)]/14 to-[var(--sky)]/14 border-primary/25",
                    cell.ring === "good" &&
                      "ring-2 ring-[var(--sage)]/45 bg-[var(--sage-soft)]/55",
                    cell.ring === "bad" &&
                      "ring-2 ring-[var(--terracotta)]/55 bg-[var(--terracotta-soft)]/55",
                    cell.ghost &&
                      "ring-2 ring-primary/35 bg-[color-mix(in_oklab,var(--primary)_10%,var(--card))]"
                  )}
                  style={{
                    width: "var(--demo-cell)",
        ...
        <div className="pointer-events-none mt-4">
          <div className="mx-auto w-full max-w-[92vw] rounded-2xl border bg-card/88 backdrop-blur px-4 py-4 shadow-sm ring-1 ring-primary/10 fade-in-up">
